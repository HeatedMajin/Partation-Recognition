...
#要识别的图片的相对路径
im_path = r'./image/realphoto.jpg'
#im_path = r'./image/tests.png'
#im_path = r'./image/r2.jpg'
#im_path = r'./image/testf.jpg'
###############################################
...
if __name__=="__main__":
    ...
    with tf.Session() as sess:
        ...
        img_mx784 = pp.segment_picture(im_path)   #切分图片
        result = sess.run(prediction,feed_dict={xs:img_mx784})
        
        print("预测结果:")
        res = sess.run(tf.arg_max(result,1))
        for i in res:
            print(i)